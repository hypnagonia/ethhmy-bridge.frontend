...
import { formatWithTwoDecimals, moreThanZero, formatBNBDecimals } from 'utils';
        ...
        >
          ...
          {exchange.step.id === EXCHANGE_STEPS.BASE ? (
            <Box direction="column" fill={true}>
              ...
              >
                <NumberInput
                  label={this.props.exchange.mode === 'eth_to_one' ? `Binance HRC20-1DC
 Amount` : 'Harmony BNB Amount'}
                  name="amount"
                  type="decimal"
                  placeholder="0"
                  style={{ width: '100%' }}
                ...
                <Text size="small" style={{ textAlign: 'right' }}>
                  <b>*Max Available</b> ={' '}
                  {formatBNBDecimals(this.tokenInfo.maxAmount)}{' '}
